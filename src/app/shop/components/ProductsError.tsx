    ...
    <div className="text-center py-12">
      <div className="max-w-md mx-auto">
        ...
        <motion.button
          ...
          whileTap={{ scale: 0.95 }}
          className="px-6 py-3 rounded-full font-semibold bg-burgundy text-white hover:bg-burgundy/90 transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
        >
